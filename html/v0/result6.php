...
<body>
  ...
  <div class="container-fluid">
                ...
                <table id="table" class="table table-sm table-striped">
                  <thead>
                    <tr class="d-flex">
                      ...
                      <th scope="col" class="col-2">Chinese Name</th>
                      ...
                      <th scope="col" class="col-2">Indications</th>
                      <th scope="col" class="col-2">Dosage</th>
            ...
            $sql = "SELECT * FROM `book3-Medicinal_plants_in_China` WHERE English_Name LIKE '$selected_val'";
            $result = mysqli_query($conn,$sql);
            
            while($row = mysqli_fetch_assoc($result)){
            echo "<tr class='d-flex'>
                    <td class='col-2'>{$row['Plant_Name']}</td>
                    <td class='col-2'>{$row['Chinese_Name']}</td>
                    ...
                    <td class='col-2'>{$row['Indications']}</td>
                    <td class='col-2'>{$row['Dosage']}</td>
                    <td class='col-3'>
