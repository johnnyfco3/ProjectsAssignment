...
if(isset($_POST['submit'])){
    $fields = array('Plant_Name','English_Name','Local_Name','Description','Habitat','Distribution','Constituents','Biological_Activity','Traditional Uses');
    $conditions = array();
    ...
    // builds the query 
    $query = "SELECT * FROM `book4-Medicinal_plants_South_Pacific` ";
...
while($row = mysqli_fetch_assoc($result)){
  echo "<tr>
      ...
      <td>{$row['Constituents']}</td>
      <td>{$row['Biological_Activity']}</td>
