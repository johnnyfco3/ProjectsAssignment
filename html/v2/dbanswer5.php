...
<body>
  ...
  if (isset($_GET['ID'])) {
    $ID = $_GET['ID'];
    $sql = "SELECT * FROM book5_MEDICINAL_PLANTS_Mongolia WHERE ID LIKE $ID";
  ...
  ?>
        ...
        <div>
            <h1 class="subtitle is-4">Mongolian Name:</h1>
            <?php echo $row['Mongolian_Name']; ?>
          </div>
        
        <div>
            <h1 class="subtitle is-4">Tibetan Name:</h1>
            <?php echo $row['Tibetan_Name']; ?>
          </div>
        ...
        <div>
            <h1 class="subtitle is-4">Synonym:</h1>
        ...
        <div>
          ...
          <div>
            <h1 class="subtitle is-4">Microscopic Characteristics:</h1>
            <?php echo $row['Microscopic_characteristics']; ?>
          </div>

          <div>
            <h1 class="subtitle is-4">Chemical Constituents:</h1>
            <?php echo $row['Chemical_constituents']; ?>
          </div>

          <div>
            <h1 class="subtitle is-4">Qualitative and quantitative assays:</h1>
            <?php echo $row['Qualitative_and_quantitative_assays']; ?>
          </div>

          <div>
            <h1 class="subtitle is-4">Qualitative and quantitative standards:</h1>
            <?php echo $row['Qualitative_and_quantitative_standards']; ?>
          </div>

          <div>
            <h1 class="subtitle is-4">Bioactivities:</h1>
      <?php echo $row['Bioactivities'];?>
          </div>
          <?php
      }
    }
