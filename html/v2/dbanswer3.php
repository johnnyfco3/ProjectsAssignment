...
<body>
  ...
  if (isset($_GET['ID'])) {
    $ID = $_GET['ID'];
    $sql = "SELECT * FROM book3_Medicinal_plants_in_China WHERE ID LIKE $ID";
  ...
  ?>
        ...
        <section style="border-style: double;border-color:green;border-width:10px;">
          ...
          <div>
            <h1 class="subtitle is-4">Chinese Nname:</h1>
            <?php echo $row['Chinese_name']; ?>
          </div>
          ...
          <div>
            <h1 class="subtitle is-4">Indications:</h1>
            <?php echo $row['Indications']; ?>
          </div>

          <div>
            <h1 class="subtitle is-4">Dosage:</h1>
            <?php echo $row['Dosage'];?>
          </div>
          <?php
      }
