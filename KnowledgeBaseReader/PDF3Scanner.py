...
with open('KnowledgeBaseReader/format3.json') as json_file: 
...
# open the PDF file
pdfFile = open('html/files/books/book3-Medicinal Plants in China.pdf', 'rb')
...
with open ('KnowledgeBaseReader/book-3.txt', mode = "w", encoding = "utf-8") as output_file:
