...
with open('KnowledgeBaseReader/format5.json') as json_file: 
...
# open the PDF file
pdfFile = open('html/files/books/book5-MEDICINAL PLANTS Mongolia.pdf', 'rb')
...
with open ('KnowledgeBaseReader/book-5.txt', mode = "w", encoding = "utf-8") as output_file:
